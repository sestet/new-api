...
func TokenAuth() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		if tokenGroup != "" {
			if _, ok := service.GetUserUsableGroups(userGroup)[tokenGroup]; !ok && tokenGroup != "auto" {
...
func SetupContextForToken(c *gin.Context, token *model.Token, parts ...string) error {
	...
	common.SetContextKey(c, constant.ContextKeyTokenRateLimitEnabled, token.HasRateLimits())
