...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.GET("/user_subscriptions", controller.AdminSearchUserSubscriptions)
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.POST("/:id/reset-rate-limit", controller.ResetTokenRateLimitUsage)
		...
		logRoute.GET("/usage", middleware.AdminAuth(), controller.GetAllUsageLogs)
		logRoute.GET("/usage/options", middleware.AdminAuth(), controller.GetAllUsageFilterOptions)
		logRoute.GET("/usage/analytics", middleware.AdminAuth(), controller.GetAllUsageAnalytics)
		logRoute.GET("/usage/self", middleware.UserAuth(), controller.GetUserUsageLogs)
		logRoute.GET("/usage/self/options", middleware.UserAuth(), controller.GetUserUsageFilterOptions)
		logRoute.GET("/usage/self/analytics", middleware.UserAuth(), controller.GetUserUsageAnalytics)
		logRoute.GET("/audit", middleware.AdminAuth(), controller.GetAuditLogs)
