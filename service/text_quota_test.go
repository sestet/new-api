...
func TestComposeTieredTextQuotaKeepsToolCallSurcharges(t *testing.T) {
	...
	require.EqualValues(t, 2_600_000, summary.ToolCallSurchargeQuota.Round(0).IntPart())
...
func TestComposeTieredTextQuotaFallbackKeepsToolCallSurcharges(t *testing.T) {
	...
	require.EqualValues(t, 2_500_000, summary.ToolCallSurchargeQuota.Round(0).IntPart())
	require.EqualValues(t, 2_501_250, quota)
}
...
func TestComposeTieredTextQuotaErrorFallbackUsesPreConsumedQuota(t *testing.T) {
	...
	require.EqualValues(t, 2_500_000, summary.ToolCallSurchargeQuota.Round(0).IntPart())
	require.EqualValues(t, 2_502_000, quota)
}
